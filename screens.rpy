        ...
        if not persistent.autoload or not main_menu:
            ...
            if main_menu:
                ...
                if persistent.playthrough == 1:
                    textbutton _("ŔŗñĮ¼»ŧþŀÂŻŕěōì«") action If(persistent.playername, true=Start(), false=Show(screen="name_input", message="لطفا اسم خود را وارد کنید", ok_action=Function(FinishEnterName)))
                else:
                    textbutton _("بازی جدید") action If(persistent.playername, true=Start(), false=Show(screen="name_input", message="لطفا نام خود را به فارسی وارد کنید", ok_action=Function(FinishEnterName)))

            else:

                textbutton _("تاریخچه") action [ShowMenu("تاریخچه"), SensitiveIf(renpy.get_screen("تاریخچه") == None)]

                textbutton _("ذخیره بازی") action [ShowMenu("ذخیره"), SensitiveIf(renpy.get_screen("ذخیره") == None)]

            textbutton _("بارگذاری بازی") action [ShowMenu("بارگذاری"), SensitiveIf(renpy.get_screen("بارگذاری") == None)]
            ...
            if _in_replay:
                ...
                if persistent.playthrough != 3:
                    textbutton _("صفحه اصلی") action MainMenu()
                else:
                    textbutton _("صفحه اصلی") action NullAction()

            textbutton _("تنظیمات") action [ShowMenu("تنظیمات"), SensitiveIf(renpy.get_screen("تنظیمات") == None)]
            ...
            if renpy.variant("pc"):
                ...
                textbutton _("کمک") action [Help("README.html"), Show(screen="dialog", message="The help file has been opened in your browser.", ok_action=Hide("dialog"))]


                textbutton _("خروج") action Quit(confirm=not main_menu)
        else:
